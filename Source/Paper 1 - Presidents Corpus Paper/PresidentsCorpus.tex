...
\par 
Given the findings of this particular study, a natural progression would be to explore whether smaller numbers of transcripts and with smaller number of words in each transcript would be just as robust in detecting changes in language as a clinical setting would not have the luxury of collecting similar quantities of transcripts at the quality we have for this dataset.
