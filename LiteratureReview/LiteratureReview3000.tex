...
\par 
Orimaye et al (2017) \cite{Orimaye2017} investigated the use of machine learning algorithms to detect differences in syntactic, lexical and n-gram linguistic biomarkers to distinguish between those with a diagnosis of AD and healthy controls, they found significant differences in the uses of all three types of biomarkers but their main finding supported n-grams as the most significant predictor. Because Orimaye used the picture description task as their method of data collection, the n-grams generated are only specific to the task given and cannot be generalised. A problem with using n-grams for  \newline
\par
...
\par
Zimmerer (2016) \cite{Zimmerer2016} looking at whether language was more formulaic \newline
\par
