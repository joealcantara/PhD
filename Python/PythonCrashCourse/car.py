...
class Car():
    ...
    def __init__ (self, make, model, year):
        """ Initialise attribute for the car """
        self.make = make
        self.model = model 
        self.year = year
...
class Battery():
    ...
    def get_range(self):
        """ Print a statement describing the range of the car based on battery size """
...
class ElectricCar(Car):
    """ Models aspects of a car, specific to an electric car. """
