...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.4\textwidth}
		\includegraphics[width=150px, height=150px]{RRppronLM.jpg}
		\caption{RR Personal Pronouns - Linear Model}
	\end{minipage}		
	
	\begin{minipage}[b]{0.4\textwidth}
		\includegraphics[width=150px, height=150px]{RRppronLOESS.jpg}
