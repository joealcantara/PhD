...
\bigskip
\begin{abstract}
Several research efforts aimed at improving the early diagnosis of Alzheimer's Disease have focused on the longitudinal analysis of lexical features which have been implicated in the pre-clinical development of Alzheimer's Disease. We build on previous studies on this and continue to refine a method of extracting and analyzing language from transcripts with the long-term goal of developing this method for use in clinical practice. We evaluate this method on the unscripted question and answer portions of news conferences from three Presidents. Ronald Reagan, who would later go on to receive a diagnosis of Alzheimer's Disease and both George Herbert Walker Bush and Donald Trump who have no known diagnosis of dementia.  We found that there were several lexical features that significantly changed over time for President Reagan but did not change for either President Bush or President Trump. These features include unique words and noun usage which significantly decrease over time and pronouns (particularly personal pronouns), conjunctions and words which are related to social processes significantly increase over time. No significant trends were found in the analysis of the transcripts of President Bush or President Trump. These features have support in psychological literature and have been linked to cognitive decline in Alzheimer's Disease. We also found that non-linear models were able to more accurately map declines in RR's language over time in comparison to linear models. This work points the way to developing a comparatively non-invasive protocol that can be used in clinical settings that may be able to spot atypical declines in language use over time that may indicate the presence of Alzheimer's Disease.
